...
\caption{\label{fig:runtime} Approximated runtime in terms of number of operations to simulate $n$-photon Boson Sampling with chosen values of $\eta$ and $x$ up to 10\% error ($\epsilon=0.1$) via state (solid) or point (dashed) truncation.}
\end{figure}
