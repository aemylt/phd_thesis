...
There are several possible ways one might seek to improve this research. In this section we shall give two potential improvements, and discuss their potential. Although we cannot provide full analysis for general $n$, we can look at cases where there are a small number of photons and use this as a springboard for discussing how these improvements might work for general $n$.
