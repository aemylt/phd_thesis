...
\begin{figure}
\subfloat[\label{fig:2-photon-trace}]{\includegraphics[width=0.45\linewidth]{classical_sim/2_photon_trace-cropped}}
\hfill
\subfloat[\label{fig:3-photon-trace}]{\includegraphics[width=0.45\linewidth]{classical_sim/3_photon_trace-cropped}}

\subfloat[\label{fig:4-photon-trace}]{\includegraphics[width=0.45\linewidth]{classical_sim/4_photon_trace-cropped}}
\hfill
\subfloat[\label{fig:5-photon-trace}]{\includegraphics[width=0.45\linewidth]{classical_sim/5_photon_trace-cropped}}

\subfloat[\label{fig:6-photon-trace}]{\includegraphics[width=0.45\linewidth]{classical_sim/6_photon_trace-cropped}}
\hfill
\subfloat[\label{fig:7-photon-trace}]{\includegraphics[width=0.45\linewidth]{classical_sim/7_photon_trace-cropped}}
