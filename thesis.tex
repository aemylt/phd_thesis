...
\documentclass[ % the name of the author
                ...
                % the thesis    title (which cannot be blank)
                     title={On the hunt for a near-term quantum speedup},
...
\bibliography{introduction/introduction, preliminary_q_c/preliminary_q_c, preliminary_bs/preliminary_bs, tsp/tsp, noisy_circuit/noisy_circuit, classical_sim/classical_sim, conclusion/conclusion}
