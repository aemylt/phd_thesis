...
\noindent \change{By noting that $\sum_\tau\prod_iM_{i,\tau(i)}=\per(M)$, we can rewrite the sum over $\tau'$ into a matrix permanent and see that, up to normalisation,}
...
\change{As mentioned previously,} the probability distribution of arbitrarily distinguishable bosons is modelled as
\begin{equation}
