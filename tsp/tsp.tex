...
\end{center}
\caption{\label{fig:circuit-procedure} An example of the circuit procedure, and branching on a circuit, applied to a circuit of six vertices.}
\end{figure}
